...
const htmlOutPath = path.join(repoRoot, 'stairs-geometry-config.generated.js');
...
const htmlFile = `/* Auto-generated from stairs-geometry-config.json. Do not edit directly. */\nwindow.STAIRS_GEOMETRY_CONFIG = ${asJson};\n`;

fs.writeFileSync(reactOutPath, reactFile, 'utf8');
fs.writeFileSync(htmlOutPath, htmlFile, 'utf8');

console.log('Generated geometry config outputs:');
